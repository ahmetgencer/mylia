        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Menemen, Ulukent, Egekent ve Harmandalı&apos;nda evcil
              hayvanlarınız için güvenilir veteriner hizmeti. 7/24 yanınızdayız.
            </p>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-gray-400 hover:text-primary-light transition-colors text-sm"
                >
                  <svg
                    className="w-5 h-5 text-primary-light shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">
                  {SITE_CONFIG.workingHours} - {SITE_CONFIG.workingHoursDetail}
                </span>
              </li>
            </ul>
          </div>
